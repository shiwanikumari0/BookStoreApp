        ...
        <div className="w-full order-2 md:order-1 md:w-1/2 mt-12 md:mt-20">
          <div className="space-y-6">
            ...
            <p className="text-xl">
              ...
              nisi unde sapiente commodi impedit aperiam, dolores nihil tempore
              harum odio, culpa ipsum, repellendus quod maxime! Sit praesentium
              enim quasi impedit.
            </p>
            ...
            <input type="text" className="grow font-semibold " placeholder="Email" />
          </label>
          </div>
